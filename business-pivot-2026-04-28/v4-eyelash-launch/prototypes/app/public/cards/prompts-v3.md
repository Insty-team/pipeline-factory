...
4. 채택 1장 → `modules/cards/images/` (덮어쓰기) 또는 `final/`로 이동
...
→ 통과한 카드는 `modules/cards/images/`에 덮어쓰기 저장.
...
또는 reference 이미지 첨부:
- 세트 2 → `prototypes/reference/clipart-korea/스크린샷 2026-05-05 오후 9.31.43.png` (Banner Design 4분할)
- 세트 3 → `prototypes/reference/clipart-korea/스크린샷 2026-05-05 오후 9.30.26.png` (잃어버린 피부 - 프리미엄 클리닉 톤)
...
- 원본 prompt v2: `prototypes/modules/cards/design-cards-prompts-for-gpt.md`
- 디자인 시스템·역프롬프트 분석: `prototypes/modules/cards/design-cards-reference.md`
- 채택 5장: `modules/cards/images/`
- 재생성 대상 11장: 본 문서
