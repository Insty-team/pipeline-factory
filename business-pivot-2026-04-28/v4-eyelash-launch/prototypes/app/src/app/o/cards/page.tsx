...
const SETS: CardSet[] = [
  {
    ...
    accent: "pink",
    cards: [
      { src: "/cards/1B1_cover_vertical.png", alt: "표지 — 시술 안내 가격표" },
      { src: "/cards/1B2_eyelash_extensions.png", alt: "연장 가격표 7종" },
      { src: "/cards/1B3_eyelash_perm.png", alt: "펌 가격표 3종 + 올인원 영양펌" },
      { src: "/cards/1B4_membership_medipink.png", alt: "멤버십 4종 + 메디핑크" },
    ],
    bonus: {
      src: "/cards/1A_menu_landscape.png",
  ...
  },
  {
    ...
    accent: "rose",
    cards: [
      { src: "/cards/2A_cover.png", alt: "표지 — 내 눈매에 맞는 컬은?" },
      { src: "/cards/2B_jcurl.png", alt: "J컬 — 가장 자연스러운 라인" },
      { src: "/cards/2C_ccurl.png", alt: "C컬 — 또렷한 인형 같은 눈매" },
      { src: "/cards/2D_dcurl.png", alt: "D컬 — 가장 강한 컬링" },
      { src: "/cards/2E_eyetype_match.png", alt: "눈매별 추천 컬 매칭표" },
      { src: "/cards/2F_cta.png", alt: "상담 CTA — 궁금하신 점은 편하게" },
    ],
  },
  {
    id: "set3",
    ...
    accent: "fuchsia",
    cards: [
      { src: "/cards/3A_cover_campaign.png", alt: "캠페인 표지 — 잃어버린 자신감" },
      { src: "/cards/3B_effect_5steps.png", alt: "메디핑크 5단계 케어" },
      { src: "/cards/3C_pricing_package.png", alt: "패키지 가격 (Light · Full)" },
      { src: "/cards/3D_before_after.png", alt: "실제 손님 변화 사례 Before/After" },
      { src: "/cards/3E_cta_event.png", alt: "CTA — 첫 상담 무료 캠페인" },
    ],
  },
];
