...
**파일**: `prototypes/uareline/virtual-customer-db.csv` (66명, 14컬럼)
...
def load_customer_db():
    ...
    # Prototype demo
    return pd.read_csv('prototypes/uareline/virtual-customer-db.csv')
...
- 가상 회원 DB: `prototypes/uareline/virtual-customer-db.csv` (66명)
- Day 1 후기 raw: `Day1_data_collection/네이버지도_리뷰/`
- 알림톡 발송 (트리거 출구): `prototypes/uareline/alimtok-templates.md`
- 데이터 인프라 (손님 시트 스키마): `prototypes/uareline/measurement-sheet.md`
- 답글 자동 (단골 식별 활용): `prototypes/uareline/reviews-replies.md`
- 카드뉴스 (메디핑크 캠페인 대상자): `prototypes/uareline/design-cards-prompts-for-gpt.md`
- 진단 리포트 (Day 5 산출, 본 분석 결과 인용): `prototypes/uareline/diagnosis-report-A.md` (다음 산출물)
