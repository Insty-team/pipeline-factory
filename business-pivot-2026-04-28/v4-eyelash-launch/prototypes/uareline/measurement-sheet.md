...
- 챗봇 응답 (응대 데이터 source): `prototypes/uareline/chatbot-30q.md`
- AI 시뮬 시뮬 (시뮬 데이터 source): `prototypes/uareline/m4sim-simulation.md`
- 알림톡 발송 (발송 데이터 source): `prototypes/uareline/alimtok-templates.md`
- 답글 자동 (답글 데이터 source): `prototypes/uareline/reviews-replies.md`
- 단골 분석 (이 sheet의 손님·회원권 시트 활용): `prototypes/uareline/ltv-analysis.md` (다음 산출물)
- 대시보드 대시보드 (이 sheet에서 fetch): `prototypes/uareline/dashboard/` (다음 산출물)
