...
- 하단: "1:1 예약제·KC인증·010-4908-6511" 푸터
...
- 카드 6: 마무리 CTA "010-4908-6511로 상담" + 워터마크
...
**유어라인 매핑**: **세트 3 카드 5번 (7월 오픈 기념 이벤트·할인 카드)** — Sale 원 디자인 그대로 인용 가능. 7월 오픈 + 영양제 무료 같은 프로모션에 직접 사용.
...
**유어라인 매핑**: **7월 오픈 이벤트 카드** (별도 — 세트 3에 추가 카드 가능). 사장 핑크 톤 + 이벤트 박스 레이아웃 직접 활용. 봄 시즌 → "여름 오픈 기념"으로 변환.
