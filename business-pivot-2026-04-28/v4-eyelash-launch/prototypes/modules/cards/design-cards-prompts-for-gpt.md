...
prototypes/modules/design-cards/
...
arranged in a 2x3 grid, each illustration representing a different
service type (glue extension half-volume, glue extension max-volume,
LED extension, perm-point extension, nourishing perm, monolid perm).
Below each illustration, render a clean Korean sans-serif label
...
- 디자인 시스템·컬러 hex·역프롬프트 풀 분석: `prototypes/modules/cards/design-cards-reference.md` (v2)
- 사장 톤 한국어 콘텐츠 시드: `prototypes/seeds/seeds/uareline-prompts.md` v3
