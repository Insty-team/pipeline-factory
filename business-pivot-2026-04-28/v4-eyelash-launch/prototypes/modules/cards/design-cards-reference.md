...
> Input: `prototypes/reference/` 14장 (메뉴판 3장 + 클립아트코리아 11장)
...
- 산출: `prototypes/modules/cards/design-cards-prompts-for-gpt.md` v2
...
- 레퍼런스 14장 raw: `prototypes/reference/`
- 사용자 시술 사진 4장: `sample_pictures_0505/`
- 사장 인스타 31장 (모델 sample): `Day1_data_collection/인스타 게시물/`
- 사장 톤 프롬프트 v3 (텍스트 콘텐츠 시드): `prototypes/seeds/seeds/uareline-prompts.md`
- 콘텐츠 자동: `prototypes/modules/content/insta-blog-demo.md`
